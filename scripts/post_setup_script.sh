...
# install software
sudo pacman -S i3-wm i3status-rust otf-font-awesome dmenu sxhkd fbctrl rxvt-unicode xsel urxvt-perls vim vim-jedi glow w3m apparmor iptables clamav rkhunter firejail keepassxc privoxy tor signal-desktop git yay-git rclone pipewire pavucontrol firefox libreoffice-fresh newsboat unzip
